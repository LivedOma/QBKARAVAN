...
const Productos = () => {
  ...
  const [productos, setProductos] = useState([
    ...
    },
    {
      ...
      descripcion: 'Jabón líquido para manos aroma lavanda',
      categoria: 'Limpieza',
    ...
    },
    {
      ...
      descripcion: 'Papel higiénico suave doble hoja',
      categoria: 'Limpieza',
      subcategoria: 'Papel',
      marca: 'Kleenex',
  ...
  const categorias = ['Bebidas', 'Dulces', 'Panadería', 'Limpieza', 'Abarrotes', 'Lácteos', 'Carnes'];
        ...
        return (
          <div>
            ...
            <div style={{ fontSize: 11, color: colors.gray500 }}>
              Mín: {producto.stockMinimo} / Máx: {producto.stockMaximo}
            </div>
            <div style={{ 
              width: '100%', 
              height: 4, 
        ...
        <div style={{ display: 'grid', gap: 16 }}>
          ...
          <Card>
            ...
            <div style={{ display: 'grid', gap: 12 }}>
              ...
              <InfoRow label="Subcategoría" value={producto.subcategoria} />
              <InfoRow label="Presentación" value={producto.presentacion} />
              <InfoRow label="Unidad de Medida" value={producto.unidadMedida} />
              <InfoRow label="Código de Barras" value={producto.codigoBarras} />
          ...
          <Card>
            ...
            <div style={{ marginTop: 16, padding: 16, backgroundColor: colors.success + '20', borderRadius: 8, textAlign: 'center' }}>
              ...
              <div style={{ fontSize: 13, color: colors.gray600, marginTop: 4 }}>
                Margen de Ganancia • ${(producto.precioVenta - producto.precioCompra).toFixed(2)} por unidad
              </div>
            </div>
          </Card>
          ...
          <Card>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 16 }}>
              ...
              <div style={{ textAlign: 'center', padding: 16, backgroundColor: colors.warning + '20', borderRadius: 8 }}>
                ...
                <div style={{ fontSize: 12, color: colors.gray500, marginTop: 4 }}>Mínimo</div>
              </div>
              <div style={{ textAlign: 'center', padding: 16, backgroundColor: colors.success + '20', borderRadius: 8 }}>
                ...
                <div style={{ fontSize: 12, color: colors.gray500, marginTop: 4 }}>Máximo</div>
              </div>
            </div>
            <div style={{ 
              width: '100%', 
            ...
            <div style={{ marginTop: 12, fontSize: 13, color: colors.gray600, textAlign: 'center' }}>
              {producto.stockActual === 0 && (
                <span style={{ color: colors.danger, fontWeight: 600 }}>⚠️ Sin stock disponible</span>
              )}
              {producto.stockActual > 0 && producto.stockActual < producto.stockMinimo && (
                <span style={{ color: colors.warning, fontWeight: 600 }}>⚠️ Stock por debajo del mínimo</span>
              )}
              {producto.stockActual >= producto.stockMinimo && (
                <span style={{ color: colors.success, fontWeight: 600 }}>✓ Stock adecuado</span>
              )}
            </div>
          </Card>
          ...
          <Card>
            ...
            <div style={{ textAlign: 'center', padding: 20, backgroundColor: colors.accent + '20', borderRadius: 8 }}>
              ...
              <div style={{ fontSize: 13, color: colors.gray600, marginTop: 4 }}>
                Valor total al costo • {producto.stockActual} unidades
              </div>
            </div>
          </Card>
        </div>
